...
export default [
    new ProjectData("project-1", "Heroes & Empire: NFT", "img/projects/he/he4.png", 
    `
    <div class="paragraph">
     <strong>Heroes & Empires is an NFT-integrated idle RPG</strong> strategy game developed by Imba Studio. Featuring collectible and tradeable NFT heroes, the game combines deep strategic gameplay with modern blockchain technology. It proudly <strong> won First Prize at the Game2Blockchain 2021 </strong> competition, hosted by Axie Infinity, Kyber Network, and TomoChain.   
     </div>
    <div class="paragraph center">
        <iframe class="youtube" src="https://www.youtube.com/embed/fuEYSrGwKHU" frameborder="0" allowfullscreen></iframe>
    </div>
    <div class="paragraph center">
        <a href="https://play.google.com/store/apps/details?id=co.imba.he" target="_blank"><img src="img/projects/play-store-logo.png" alt="Play Store badge" /></a>
    </div>

    <div class="paragraph center">
        <img class="phone-screenshot" src="img/projects/he/he1.png" alt="" />
        <img class="phone-screenshot" src="img/projects/he/he2.png" alt="" />
